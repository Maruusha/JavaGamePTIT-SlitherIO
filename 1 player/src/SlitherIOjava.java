...
public class SlitherIOjava extends JFrame {
	...
	private class handler implements KeyListener {
        ...
        public void keyPressed(KeyEvent e) {
			...
			if(e.getKeyCode()==KeyEvent.VK_UP) game.s1.setVector(Snake.GO_UP);
            if(e.getKeyCode()==KeyEvent.VK_DOWN) game.s1.setVector(Snake.GO_DOWN);
            if(e.getKeyCode()==KeyEvent.VK_LEFT) game.s1.setVector(Snake.GO_LEFT);
            if(e.getKeyCode()==KeyEvent.VK_RIGHT) game.s1.setVector(Snake.GO_RIGHT);
